...
runuser -l ec2-user -c 'cd /home/ec2-user/dfms && source /home/ec2-user/virtualenv/dfms/bin/activate && dfmsDIM --daemon -vvv -H 0.0.0.0 --ssh-pkey-path ~/.ssh/id_dfms --nodes ${hosts} --log-dir /tmp'
sleep 10
