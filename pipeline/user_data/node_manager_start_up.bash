...
runuser -l ec2-user -c 'cd /home/ec2-user/dfms && source /home/ec2-user/virtualenv/dfms/bin/activate && nohup dfmsNM -vv --dfms-path=/home/ec2-user/aws-chiles02/pipeline -H 0.0.0.0 > /mnt/dfms/dfms_root/logfile.log 2>&1 &'
