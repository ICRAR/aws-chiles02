...
class WorkToDo:
    ...
    def calculate_work_to_do(self):
        ...
        for frequency_pair in list_frequencies:
            ...
            if (
                expected_tar_file not in cleaned_objects
    ...
    nodes.append(
        {
            ...
            "instance_type": "i3.8xlarge",  # on the 8xlarge av. memory eventually drops to ~40G
            ...
            ec2_data = EC2Controller(
                ...
                tags=[
                    {"Key": "Owner", "Value": getpass.getuser()},
                    {
                        ...
                        if clean_tclean == "clean"
                        else "DALiuGE NM - Tclean",
                    },
                    {"Key": "uuid", "Value": uuid},
                ],
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "tag_name", nargs="?", default="clean", help="the tag name to execute"
    )
