...
from aws_chiles02.common import FrequencyPair, get_aws_credentials, get_required_frequencies, \
...
from aws_chiles02.settings_file import AWS_REGION, DIM_PORT, WAIT_TIMEOUT_ISLAND_MANAGER, \
