...
def copy_from_s3(args):
    ...
    bash = 'java -d64 -Xms6g -Xmx6g -classpath /chiles02/awsChiles02.jar org.icrar.awsChiles02.copyS3.CopyFileFromS3' \
    ...
    if process.returncode != 0 or not os.path.exists(args.measurement_set):
        return 1
