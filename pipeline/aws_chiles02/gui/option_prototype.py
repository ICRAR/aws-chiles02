...
from option_instance import InputInstance, TextFieldInstance, SelectInstance, CheckInstance, ChooseFileInstance
...
class TextFieldPrototype(OptionPrototype):
    option_type = "Text Field"

    def create(self, parent):
        return TextFieldInstance(self, parent)
