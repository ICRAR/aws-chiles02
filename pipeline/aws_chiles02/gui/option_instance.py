...
class TextFieldInstance(OptionInstance):
    def __init__(self, prototype, parent):
        """
        Create a new TextFieldInstance
        :param parent: The parent frame for this instance.
        """
        super(TextFieldInstance, self).__init__(parent)
        self.text = tk.Text(parent, width=28, height=6)
        self.set_prototype(prototype)
    ...
    def write(self, value):
        ...
        self.text.insert('1.0', self.prototype.validate_and_convert(value))
    ...
    def position(self, row, column):
        ...
        :return:
        """
        super(TextFieldInstance, self).position(row, column)
        self.text.grid(row=row, column=column + 1, rowspan=3)
    ...
    def unposition(self):
        ...
        :return:
        """
        super(TextFieldInstance, self).unposition()
    ...
    def set_prototype(self, prototype):
        ...
        :return:
        """
        super(TextFieldInstance, self).set_prototype(prototype)
        self.write(self.prototype.get_default())
