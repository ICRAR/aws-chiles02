...
# Included uvrange='>1500m', removed 3C84 code
# 8/26/15 DJP
    ...
    gaincal(vis=calMs,caltable=calTable,field='',spw=calSpw,intent='',\
            selectdata=True,uvrange='>1500m',scan=calScans,\
...
######################################################################
#EM: adding definitions for the spwmap parameter for the delay calibration
#The HI subbands are all from the A0C0 side, so choose one RFI free subband
#and use it for the delay calibration of the baseband. E.g., choose the last one
# which is subband 14 (when counting from 0).
