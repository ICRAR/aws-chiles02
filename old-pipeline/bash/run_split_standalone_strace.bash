...
bash -xv /home/ec2-user/chiles_pipeline/bash/ioprofiler-trace.sh -o /tmp/trace_logs/strace_split.log casapy --nologger  --log2term --logfile casapy.log  -c /home/ec2-user/chiles_pipeline/standalone/standalone_split.py
